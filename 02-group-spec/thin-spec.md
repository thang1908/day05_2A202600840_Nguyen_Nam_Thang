...
|---|---|---|
| Nguyễn Nam Thắng | SPEC / tổng hợp nội dung repo | `thin-spec.md`, link prototype, phần giải thích build slice. |
| Thành viên 2 | Research / evidence | Ghi chú phỏng vấn nhanh 2-3 người hoặc review/comment public, cập nhật `evidence-pack.md`. |
| Thành viên 3 | Prototype | Source code chatbot, màn hình chat, flow gợi ý chuyên khoa và slot khám. |
| Thành viên 4 | Test / failure path | Test cases happy, low-confidence, failure, correction; screenshot kết quả. |
| Thành viên 5 | Demo script / repo | Kịch bản demo 3-5 phút, README, ảnh minh họa trước/sau. |
